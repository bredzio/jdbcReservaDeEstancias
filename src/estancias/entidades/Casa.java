...
public class Casa {
    ...
    public Casa(Integer id_casa, String calle, Integer numero, String codigo_postal, String ciudad, String pais, Date fecha_desde, Date fcha_hasta, Integer tiempo_minimo, Integer tiempo_maximo, Double precio_habitacion, String tipo_vivienda) {
    ...
    public Date getFcha_hasta() {
        return fcha_hasta;
    }

    public void setFcha_hasta(Date fcha_hasta) {
        this.fcha_hasta = fcha_hasta;
    }
